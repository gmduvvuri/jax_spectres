import numpy as np
from jax_spectres import jax_spectres
from matplotlib import pyplot as plt
from matplotlib import gridspec


# Code copied nearly verbatim from 
...
# Does not make a direct comparison to spectres output
# to avoid requiring it for installation.
...
spec_resample, spec_errs_resample = jax_spectres(regrid, spectrum[:,0], spectrum[:,1], spec_errs=spectrum[:,2])
